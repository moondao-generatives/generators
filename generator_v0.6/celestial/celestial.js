	...
	function form(cfg) {
		...
		*/
		...
		for (var fld in names) {
			...
			//col.append("label").attr("for", "stars-" + fld + "Limit").html("down to magnitude");
		...
		col.append("br");
		col.append("label").attr("for", "stars-size").attr("class", "advanced").html("Stellar disk size ");
		...
		col.append("label").attr("for", "stars-exponent").attr("class", "advanced").html(" * e^");
	...
	*/
	...
	function geo(cfg) {
		...
		*/
		...
		col.append("label").attr("title", "Show solar system objects").attr("for", "planets-show").html(" Planets, Sun and Moon");
